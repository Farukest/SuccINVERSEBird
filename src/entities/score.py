...
class Score(Entity):
    ...
    def add(self) -> None:
        self.score += 1
        self.config.sounds.point.play()  # Her puan için normal ses
        if self.score % 5 == 0:  # Her 10 puanda özel ses
            self.config.sounds.ten_points.play()  # Sounds sınıfında tanımlıysa
